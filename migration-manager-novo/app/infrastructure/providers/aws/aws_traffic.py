"""Implementacao inicial (stub) de TrafficProvider para AWS/Floci.

Mantem um mapa em memoria de service_id -> endpoint atual, simulando um
mecanismo de roteamento (ex: um Load Balancer ou API Gateway) sem depender
de uma integracao real neste momento.
"""
...
class AWSTrafficProvider(TrafficProvider):
    """Provedor de trafego experimental/stub para AWS/Floci."""
