"""Implementacao inicial (stub) de DataMigrationProvider para RDS/Floci.

Simula a migracao de dados copiando um contador de "registros" fake, para
permitir que o fluxo completo do MigrationManager seja executado e testado
antes que uma estrategia real de transferencia de dados (ex: dump/restore,
CDC, replication) seja implementada.
"""
...
class AWSRDSDataMigrationProvider(DataMigrationProvider):
    """Implementacao experimental/stub de migracao de dados via RDS/Floci."""
